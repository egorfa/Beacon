...
public class TeacherDBManager {
    ...
    // changed to suit your needs.
    private final static String TABLE_NAME = "TeacherDB";
    private final static String TABLE_ROW_ID = "ID";
    private final static String TABLE_ROW_NAME = "Name";
    private final static String TABLE_ROW_IMAGE = "Image";

    public TeacherDBManager(Context context)
    {
    ...
    public void addRow(String rowStringName, String rowStringImage)
    {
        // this is a key value pair holder used by android's SQLite functions
        ContentValues values = new ContentValues();
        values.put(TABLE_ROW_NAME, rowStringName);
        values.put(TABLE_ROW_IMAGE, rowStringImage);
    ...
    public String findImageByTeacherID(String TeacherID){

        Cursor cursor;
        String prm = String.valueOf(-1);
        String selection = TeacherDBManager.TABLE_ROW_ID + " = '" + TeacherID + "'";
        try {
            ...
            cursor = db.query
                    (
                            TABLE_NAME,
                            new String[]{TeacherDBManager.TABLE_ROW_IMAGE},
                            selection,
                            null,
                            null, null, null, null
                    );
    ...
    public String findNameByTeacherID(String TeacherID) {
        ...
        try {
            ...
            cursor = db.query
                    (
                            TABLE_NAME,
                            new String[]{TeacherDBManager.TABLE_ROW_NAME},
                            selection,
                            null,
                            null, null, null, null
                    );
    ...
    public void updateRow(long rowID, String rowStringName, String rowStringImage)
    {
        // this is a key value pair holder used by android's SQLite functions
        ContentValues values = new ContentValues();
        values.put(TABLE_ROW_NAME, rowStringName);
    ...
    public ArrayList<Object> getRowAsArray(long rowID)
    {
        ...
        try
        {
            ...
            cursor = db.query
                    (
                            TABLE_NAME,
                            new String[] { TABLE_ROW_ID, TABLE_ROW_NAME, TABLE_ROW_IMAGE},
                            TABLE_ROW_ID + "= ?",
